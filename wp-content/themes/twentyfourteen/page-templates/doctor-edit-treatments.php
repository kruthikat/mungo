...
?>
	...
	<p>
		...
		<?php echo $outselected; ?> /> Out-Patient <input type="radio" name="PatientStatus"
		value="1" id="In-Patient" <?php echo $inselected; ?> /> In-Patient
   	</p>
...
global $wpdb;
	...
	$In_Patients=new UpdateDatabaseOptions('in_patients');
		...
		<?php echo $yesselected; ?> /> YES<input type="radio" name="discharge_date"
		'value="0" id="NO"' <?php echo $noselected; ?> /> NO
		<?php
		}
		?>
	</p>
